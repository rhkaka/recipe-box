...
**Password:** the hosted copy asks for a password (not case-sensitive). Set
`RECIPE_BOX_PASSWORD` in `.env` before building; the recipe data is then encrypted in the repo
